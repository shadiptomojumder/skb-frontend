...
const Contact = () => {
    return (
        <section className="bg-slate-100 py-28">
            <div className="container mx-auto grid gap-8 lg:grid-cols-1">
                {/* Left Section */}
                <div className="flex flex-col justify-center space-y-8 text-center">
                    <div className="space-y-5">
                        <p className="text-4xl font-bold text-slate-600">Contact Us</p>
                ...
                <div className="mx-auto w-3xl rounded-lg border bg-card p-6 shadow-sm">
                    <ContactForm />
                </div>
            </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-start gap-1.5">
                            ...
                            <a
                                ...
                                title="Our address"
                                className="hover:text-gary-800 w-[300px] font-rubik font-semibold text-gray-900 transition-colors duration-300">
                    ...
                    <div className="space-y-2">
                                        ...
                                        <mask id="ipTWechat0">
                                            <g fill="none">
                                                <path
                                                    fill="#555555"
                                                    fillRule="evenodd"
                                                    d="M36.997 21.711C36.843 13.008 29.74 6 21 6C12.163 6 5 13.163 5 22c0 4.17 1.595 7.968 4.209 10.815l-1.199 7.21l7.115-3.055q4.702 1.563 8.875.782"
                                                ...
                                                <path
                                                    ...
                                                    strokeLinejoin="round"
                                                    strokeWidth={4}
                                                    d="M36.997 21.711C36.843 13.008 29.74 6 21 6C12.163 6 5 13.163 5 22c0 4.17 1.595 7.968 4.209 10.815l-1.199 7.21l7.115-3.055q4.702 1.563 8.875.782"></path>
                                                <path
                                                    fill="#fff"
                                                    d="M15.125 20.467a2.26 2.26 0 0 0 2.25-2.267a2.26 2.26 0 0 0-2.25-2.267a2.26 2.26 0 0 0-2.25 2.267a2.26 2.26 0 0 0 2.25 2.267m9 0a2.26 2.26 0 0 0 2.25-2.267a2.26 2.26 0 0 0-2.25-2.267a2.26 2.26 0 0 0-2.25 2.267a2.26 2.26 0 0 0 2.25 2.267"></path>
                                                <path
                                                    fill="#555555"
                                                    fillRule="evenodd"
                                                    d="M38.762 39.93A10.45 10.45 0 0 1 32.5 42C26.701 42 22 37.299 22 31.5S26.701 21 32.5 21S43 25.701 43 31.5c0 1.6-.358 3.116-.998 4.473"
                                                    clipRule="evenodd"></path>
                                                <path
                                                    stroke="#fff"
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                                    strokeWidth={4}
                                                    d="M38.762 39.93A10.45 10.45 0 0 1 32.5 42C26.701 42 22 37.299 22 31.5S26.701 21 32.5 21S43 25.701 43 31.5c0 1.6-.358 3.116-.998 4.473"></path>
                                                <path
                                                    fill="#555555"
                                                    fillRule="evenodd"
                                                ...
                                                <path
                                                    fill="#fff"
                                                    d="M35.688 30.8A1.694 1.694 0 0 1 34 29.1c0-.939.755-1.7 1.688-1.7c.931 0 1.687.761 1.687 1.7s-.755 1.7-1.687 1.7m-6.75 0a1.694 1.694 0 0 1-1.688-1.7c0-.939.756-1.7 1.688-1.7s1.687.761 1.687 1.7s-.756 1.7-1.687 1.7"></path>
                                            </g>
                                        </mask>
                                    </defs>
                                    <path
                        ...
                        <div className="flex items-start gap-1.5">
                            ...
                            <a
                                ...
                                title="Our address"
                                className="hover:text-gary-800 w-[300px] font-rubik font-semibold text-gray-900 transition-colors duration-300">
                                Building 6, Kaixuan International Apartment, No. 106, Sandong
                                Avenue, Huadu District, Guangzhou.
                            </a>
                        </div>
                    </div>
                    <div>
